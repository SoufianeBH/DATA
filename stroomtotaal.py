...
negen = pd.read_csv("GAS_ELK/ELK_2009.csv")
tien = pd.read_csv("GAS_ELK/ELK_2010.csv")
elf = pd.read_csv("GAS_ELK/ELK_2011.csv")
twaalf = pd.read_csv("GAS_ELK/ELK_2012.csv")
dertien = pd.read_csv("GAS_ELK/ELK_2013.csv")
veertien = pd.read_csv("GAS_ELK/ELK_2014.csv")
vijftien = pd.read_csv("GAS_ELK/ELK_2015.csv")
zestien = pd.read_csv("GAS_ELK/ELK_2016.csv")
...
p1 = figure(x_axis_type="datetime", title="Totale Stroomverbruik")
...
p1.line(jaartal, perjaar, legend='stroom', color='navy')

output_file("stroom.html", title="stroom.py example")
show(p1)
